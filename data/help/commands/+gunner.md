...
examples:
  ...
  - cmd: "+gunner/fire Vulture-3"
    description: "Fire your weapon at Vulture-3. Starship Gunnery roll vs target's maneuver + range."
  - cmd: "fire Vulture-3"
    description: "Same as +gunner/fire (bare alias preserved)."
  - cmd: "+gunner/lockon Vulture-3"
    description: "Establish weapons lock on Vulture-3. Successful lock = +2D on the next /fire."
  - cmd: "lockon Vulture-3"
    description: "Same as +gunner/lockon (bare alias preserved)."
  - cmd: "lock Vulture-3"
    description: "Short bare alias for /lockon."
  - cmd: "targetlock Vulture-3"
...
lockon, etc.) still work as aliases — typing `fire Vulture-3` and
`+gunner/fire Vulture-3` reach the same code. The canonical form is
...
Some ships have multiple gunner seats (YT-1300 has 2, Hyena Bomber

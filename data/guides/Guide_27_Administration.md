...
| `@balance` (`@bal`) | telemetry dashboard — the *behavioural* read-side of `@economy` (grind/cp/flows/objectives/chains/encounters/events/sessions/skills/progress/raw) |

...
**Freelance side-jobs.** Open to anyone — no faction, no reputation, no prerequisite beyond having a finished character. They run in ordinary city rooms, pay a modest reward (around **300 credits** plus a little Independent standing and an achievement), and exist to give every character somewhere purposeful to go when the mission board feels stale. Eleven ship at launch, each leading with a different skill so they reward different builds — one of them, *The Sealed Ledger*, resolves entirely on finesse, with no fight at all, for the slicer or scoundrel who would rather never draw a blaster; another, *The Sabotaged Run*, hands the wheel to a pilot or scanner who would rather win on the speeder track than in a firefight; and a third, *The Hollow Crew*, rewards the scholar of aliens and the droid-tech, who reads a hive caste and cracks a stolen droid core rather than talk or shoot their way through:

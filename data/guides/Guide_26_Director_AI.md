...
**The reward is Republic reputation, a rout bounty, and a relic.** Break a cult and everyone who helped gains **Republic reputation** — more for a larger share of the effort (roughly 3 for a single strike, up to 15 for the largest contributor) — and the players who carried the most of the fight earn a commemorative status flag marking that they helped rout that cult. Everyone who did a meaningful share of the fight also collects a **credit bounty** for the rout, and the single top contributor takes home a one-off **cult relic** — a rare, multi-stage win is worth showing up for. A loss costs you nothing — an uprising is an opportunity, never a penalty.

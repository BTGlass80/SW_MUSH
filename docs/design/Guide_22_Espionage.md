# SW_MUSH Detailed Systems Guide #22
# Espionage
...
A skilled assessor catching a wounded character with the right margin sees things like: *"They look tense, hand near their weapon. Wounded — a recent fight. Armed with a blaster pistol, Imperial-issue. The way they hold themselves suggests military training."*
...
Assess is the **opening move** of an espionage scene. Walking into a room, you can assess up to half a dozen characters quickly to gauge who's interesting. The wounded character with Imperial gear is probably worth investigating further; the relaxed bartender with no equipment is probably not.
...
Example:
```
+intel create Imperial Garrison Activity at Mos Eisley
+intel add Two new TIE Bombers arrived this week, hangared in Bay 8.
...
A good faction intelligence officer compiles reports that pay (or earn rep) when traded to interested parties. Intel about Imperial movements has value to Republic Intel; intel about Republic supply convoys has value to CIS or Hutt buyers. The trade network emerges organically.
...
**Scenario 3 — The investigation discovery.** A combat just ended in a Coruscant alley. You arrive after the fighters have left. You `investigate`. You find a torn piece of a uniform with Imperial insignia, a blood smear suggesting the loser was wounded, and a small audio recording device (apparently dropped during the fight). The recorder still has data; combined with your read of the scene, you piece together the encounter.
...
**4. Composing intel from common knowledge.** A report saying "the Empire has soldiers" is worthless. Reports must contain information that wasn't already known to the recipient. Don't waste effort on common knowledge.

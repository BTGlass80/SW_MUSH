# SW_MUSH Detailed Systems Guide #24
# Encounters & Hazards
...
- An Imperial patrol decloaks and demands a scan.
...
### Patrol — Imperial / Republic / Police Stop

**Trigger:** You're in a contested or secured space zone. The patrol's faction matches the zone's affiliation (Republic patrols in Republic space, Imperial-flavor in Imperial-aligned zones, etc.).
...
**Practical wisdom:** Comply if you're clean. Bluff if your character has good Con. Run if your ship is fast (A-Wing, modded freighter). Hide if your Sneak is strong and you're in a debris-rich zone. Each choice's success rate depends on your specific build and the patrol's tier.
...
| **Imperial** | A small Imperial outpost — investigate (cautiously). |
...
**3. Trying to bluff Imperial patrols with low Con.** The bluff difficulty in secured zones is 20. If your Con is 3D, you'll fail more than you succeed. Comply instead.

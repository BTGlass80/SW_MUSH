# SW_MUSH Detailed Systems Guide #12
# Player Cities
...
3. That HQ must be in a zone with **declared contested or lawless security**. Cities cannot be founded in Imperial-secured zones — by design, the system is for frontier and underworld governance. The Empire doesn't permit private cities inside its territory; the Republic doesn't either.

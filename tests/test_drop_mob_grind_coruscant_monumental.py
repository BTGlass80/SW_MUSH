# -*- coding: utf-8 -*-
"""
tests/test_drop_mob_grind_coruscant_monumental.py

Verifies the Coruscant Monumental District hostile-mob grind expansion (10 NPCs).
...
MOB_FILE = os.path.join(CW_DIR, "npcs_drop_mob_grind_coruscant_monumental.yaml")
...
class TestEraManifestRef(unittest.TestCase):
    def test_file_in_era_yaml(self):
        ...
        ref_name = "npcs_drop_mob_grind_coruscant_monumental.yaml"
        self.assertIn(
            ref_name, npcs_refs,

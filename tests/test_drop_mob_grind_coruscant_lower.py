# -*- coding: utf-8 -*-
"""
tests/test_drop_mob_grind_coruscant_lower.py

Verifies the Coruscant Lower City hostile-mob grind expansion
(data/worlds/clone_wars/npcs_drop_mob_grind_coruscant_lower.yaml).
...
MOB_FILE = os.path.join(CW_DIR, "npcs_drop_mob_grind_coruscant_lower.yaml")
...
class TestEraManifestRef(unittest.TestCase):
    def test_file_in_era_yaml(self):
        ...
        ref_name = "npcs_drop_mob_grind_coruscant_lower.yaml"
        self.assertIn(
            ref_name, npcs_refs,

# -*- coding: utf-8 -*-
"""
tests/test_drop_ambient_coruscant_monumental.py

Static-invariant tests for the Coruscant Monumental/Upper-City ambient NPC batch
(data/worlds/clone_wars/npcs_drop_ambient_coruscant_monumental.yaml).

Five non-hostile flavor NPCs across five previously-empty Coruscant rooms:
  Coruscant Opera House              x1  (Lissara Fen / Twi'lek lead soprano)
  Column Commons District            x1  (Davan Merys / Human war correspondent)
  Upper City Promenade               x1  (Jev Mossa / Human restaurant proprietor)
  The Western Sea                    x1  (Ott Coro / Sullustan dock manager)
  Calocour Heights - Marketing Row   x1  (Brell Oskan / Bothan account director)
...
Verifies:
  ...
  7. Room references resolve to real Coruscant rooms
...
YAML_PATH = os.path.join(CW_DIR, "npcs_drop_ambient_coruscant_monumental.yaml")
...
EXPECTED_ROOMS = {
    "Coruscant - Coruscant Opera House",
    "Coruscant - Column Commons District",
    "Coruscant - Upper City Promenade",
    "Coruscant - The Western Sea",
    "Coruscant - Calocour Heights - Marketing Row",
}
...
class TestEraRegistration(unittest.TestCase):
    def test_yaml_in_era_npcs_list(self):
        ...
        self.assertIn(
            "npcs_drop_ambient_coruscant_monumental.yaml",
            names,
            "npcs_drop_ambient_coruscant_monumental.yaml not in era.yaml content_refs.npcs",
        )

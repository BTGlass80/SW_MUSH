# -*- coding: utf-8 -*-
"""
tests/test_drop_mob_grind_geonosis_foundries_expansion.py

Verifies the Geonosis Foundries Expansion hostile-mob grind batch
(data/worlds/clone_wars/npcs_drop_mob_grind_geonosis_foundries_expansion.yaml).

Covers 5 geonosis_foundries zone rooms + the E'Y-Akh Desert Edge.
...
MOB_FILE = os.path.join(CW_DIR, "npcs_drop_mob_grind_geonosis_foundries_expansion.yaml")
...
class TestEraManifestRef(unittest.TestCase):
    def test_file_in_era_yaml(self):
        ...
        ref_name = "npcs_drop_mob_grind_geonosis_foundries_expansion.yaml"
        self.assertIn(
            ref_name, npcs_refs,

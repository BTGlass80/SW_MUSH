# -*- coding: utf-8 -*-
"""
tests/test_drop_mob_grind_kamino.py

Verifies the Kamino hostile-mob grind batch
(data/worlds/clone_wars/npcs_drop_mob_grind_kamino.yaml).
...
MOB_FILE = os.path.join(CW_DIR, "npcs_drop_mob_grind_kamino.yaml")
...
class TestEraManifestRef(unittest.TestCase):
    def test_file_in_era_yaml(self):
        ...
        ref_name = "npcs_drop_mob_grind_kamino.yaml"
        self.assertIn(
            ref_name, npcs_refs,

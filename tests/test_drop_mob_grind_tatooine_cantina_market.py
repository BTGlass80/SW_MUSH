# -*- coding: utf-8 -*-
"""
tests/test_drop_mob_grind_tatooine_cantina_market.py

Verifies the Tatooine cantina and market rooms hostile-mob grind expansion (6 NPCs):
Chalmun's Cantina (3 rooms) + Market Place stalls (3 rooms).
...
MOB_FILE = os.path.join(CW_DIR, "npcs_drop_mob_grind_tatooine_cantina_market.yaml")
...
class TestEraManifestRef(unittest.TestCase):
    def test_file_in_era_yaml(self):
        ...
        ref_name = "npcs_drop_mob_grind_tatooine_cantina_market.yaml"
        self.assertIn(
            ref_name, npcs_refs,

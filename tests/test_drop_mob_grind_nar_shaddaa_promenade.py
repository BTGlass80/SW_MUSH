# -*- coding: utf-8 -*-
"""
tests/test_drop_mob_grind_nar_shaddaa_promenade.py

Verifies the Nar Shaddaa Corellian Sector promenade hostile-mob grind expansion
(data/worlds/clone_wars/npcs_drop_mob_grind_nar_shaddaa_promenade.yaml).
...
MOB_FILE = os.path.join(CW_DIR, "npcs_drop_mob_grind_nar_shaddaa_promenade.yaml")
...
class TestEraManifestRef(unittest.TestCase):
    def test_file_in_era_yaml(self):
        ...
        ref_name = "npcs_drop_mob_grind_nar_shaddaa_promenade.yaml"
        self.assertIn(
            ref_name, npcs_refs,

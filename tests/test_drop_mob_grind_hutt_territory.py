# -*- coding: utf-8 -*-
"""
tests/test_drop_mob_grind_hutt_territory.py

Verifies the Hutt Territory hostile-mob grind expansion: 2 NPCs in Nar Shaddaa Hutt Emissary Tower,
2 in Jabba's Townhouse (4 total).
...
MOB_FILE = os.path.join(CW_DIR, "npcs_drop_mob_grind_hutt_territory.yaml")
...
class TestEraManifestRef(unittest.TestCase):
    def test_file_in_era_yaml(self):
        ...
        ref_name = "npcs_drop_mob_grind_hutt_territory.yaml"
        self.assertIn(
            ref_name, npcs_refs,

# -*- coding: utf-8 -*-
"""
tests/test_drop_ambient_kuat_civic.py

Static-invariant tests for the Kuat Civic & Residential ambient NPC batch
(data/worlds/clone_wars/npcs_drop_ambient_kuat_civic.yaml).

Four non-hostile flavor NPCs across four previously-empty Kuat rooms:
  Ring Medical Center          x1  (Dr. Sel Narro / Human physician)
  Spaceport Concourse Hotel    x1  (Shift Manager Drem Avosi / Human)
  The Embassy Inn              x1  (Talvik Maru / Human -- named in room desc)
  Embassy Residential Row      x1  (Embassy Aide Sarle Tok / Mirialan)
...
YAML_PATH = os.path.join(CW_DIR, "npcs_drop_ambient_kuat_civic.yaml")
...
EXPECTED_NPCS = {
    "Dr. Sel Narro",
    "Shift Manager Drem Avosi",
    "Talvik Maru",
    "Embassy Aide Sarle Tok",
}

EXPECTED_ROOMS = {
    "Kuat Drive Yards - Ring Medical Center",
    "Kuat - Spaceport Concourse Hotel",
    "Kuat City - The Embassy Inn",
    "Kuat City - Embassy Residential Row",
}
...
class TestEraRegistration(unittest.TestCase):
    def test_yaml_in_era_npcs_list(self):
        ...
        self.assertIn(
            "npcs_drop_ambient_kuat_civic.yaml",
            names,
            "npcs_drop_ambient_kuat_civic.yaml not in era.yaml content_refs.npcs",
        )

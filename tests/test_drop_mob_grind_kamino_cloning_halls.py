# -*- coding: utf-8 -*-
"""
tests/test_drop_mob_grind_kamino_cloning_halls.py

Verifies the Kamino Cloning Halls hostile-mob grind batch
(data/worlds/clone_wars/npcs_drop_mob_grind_kamino_cloning_halls.yaml).
...
MOB_FILE = os.path.join(CW_DIR, "npcs_drop_mob_grind_kamino_cloning_halls.yaml")
...
class TestEraManifestRef(unittest.TestCase):
    def test_file_in_era_yaml(self):
        ...
        ref_name = "npcs_drop_mob_grind_kamino_cloning_halls.yaml"
        self.assertIn(
            ref_name, npcs_refs,

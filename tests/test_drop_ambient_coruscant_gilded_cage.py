# -*- coding: utf-8 -*-
"""
tests/test_drop_ambient_coruscant_gilded_cage.py

Static-invariant tests for the Coruscant Gilded Cage ambient NPC batch
(data/worlds/clone_wars/npcs_drop_ambient_coruscant_gilded_cage.yaml).

Six non-hostile flavor NPCs across three Gilded Cage rooms:
  Gilded Cage - Alien Quarter    x2  (Noss Vareen / Yeen-Kel)
  Gilded Cage - Bazaar           x2  (Torval Kess / Faan Ukh)
  Gilded Cage - Courtyard        x2  (Orren Vrass / Dara Sel)
...
YAML_PATH = os.path.join(CW_DIR, "npcs_drop_ambient_coruscant_gilded_cage.yaml")
...
class TestEraRegistration(unittest.TestCase):
    def test_yaml_in_era_npcs_list(self):
        ...
        self.assertIn(
            "npcs_drop_ambient_coruscant_gilded_cage.yaml",
            names,
            "npcs_drop_ambient_coruscant_gilded_cage.yaml not in era.yaml content_refs.npcs",
        )

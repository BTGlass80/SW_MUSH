# -*- coding: utf-8 -*-
"""
tests/test_drop_ambient_tatooine_despot_commerce.py

Static-invariant tests for the Mos Eisley Commercial & Criminal Hospitality
ambient NPC batch
(data/worlds/clone_wars/npcs_drop_ambient_tatooine_despot_commerce.yaml).

Four non-hostile flavor NPCs across four previously-uncovered rooms:
  Transport Depot                      x1  (Yvonne Targis / Human)
  Heff's Souvenirs                     x1  (Moplin / Human)
  Lucky Despot Hotel - Grand Staircase x1  (Naressa Vell / Twi'lek)
  Lucky Despot - Star Chamber Cafe     x1  (Calos Renk / Human)
...
YAML_PATH = os.path.join(CW_DIR, "npcs_drop_ambient_tatooine_despot_commerce.yaml")
...
class TestEraRegistration(unittest.TestCase):
    def test_yaml_in_era_npcs_list(self):
        ...
        self.assertIn(
            "npcs_drop_ambient_tatooine_despot_commerce.yaml",
            names,
            "npcs_drop_ambient_tatooine_despot_commerce.yaml not in era.yaml content_refs.npcs",
        )

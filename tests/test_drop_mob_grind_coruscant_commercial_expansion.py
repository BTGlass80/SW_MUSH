# -*- coding: utf-8 -*-
"""
tests/test_drop_mob_grind_coruscant_commercial_expansion.py

Verifies the Coruscant commercial_district hostile-mob grind expansion (6 NPCs).
...
MOB_FILE = os.path.join(CW_DIR, "npcs_drop_mob_grind_coruscant_commercial_expansion.yaml")
...
class TestEraManifestRef(unittest.TestCase):
    def test_file_in_era_yaml(self):
        ...
        ref_name = "npcs_drop_mob_grind_coruscant_commercial_expansion.yaml"
        self.assertIn(
            ref_name, npcs_refs,

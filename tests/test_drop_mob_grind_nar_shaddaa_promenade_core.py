# -*- coding: utf-8 -*-
"""
tests/test_drop_mob_grind_nar_shaddaa_promenade_core.py

Verifies the Nar Shaddaa Corellian Sector promenade core-rooms hostile-mob grind
expansion (data/worlds/clone_wars/npcs_drop_mob_grind_nar_shaddaa_promenade_core.yaml).
...
MOB_FILE = os.path.join(CW_DIR, "npcs_drop_mob_grind_nar_shaddaa_promenade_core.yaml")
...
class TestEraManifestRef(unittest.TestCase):
    def test_file_in_era_yaml(self):
        ...
        ref_name = "npcs_drop_mob_grind_nar_shaddaa_promenade_core.yaml"
        self.assertIn(
            ref_name, npcs_refs,

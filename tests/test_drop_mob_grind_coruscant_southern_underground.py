# -*- coding: utf-8 -*-
"""
tests/test_drop_mob_grind_coruscant_southern_underground.py

Verifies the Coruscant southern_underground hostile-mob grind expansion
(data/worlds/clone_wars/npcs_drop_mob_grind_coruscant_southern_underground.yaml).
...
MOB_FILE = os.path.join(
    CW_DIR, "npcs_drop_mob_grind_coruscant_southern_underground.yaml"
)
...
class TestYamlParses(unittest.TestCase):
    ...
    def test_six_npcs(self):
        ...
        self.assertGreaterEqual(
            len(data["npcs"]), 6, "Expected at least 6 hostile mobs"
        )
...
class TestEraManifestRef(unittest.TestCase):
    def test_file_in_era_yaml(self):
        ...
        ref_name = "npcs_drop_mob_grind_coruscant_southern_underground.yaml"
        self.assertIn(
            ref_name,
            npcs_refs,

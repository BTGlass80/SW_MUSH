# -*- coding: utf-8 -*-
"""
tests/test_drop_ambient_mos_eisley_service_sector.py

Static-invariant tests for the Mos Eisley Service Sector ambient NPC batch
(data/worlds/clone_wars/npcs_drop_ambient_mos_eisley_service_sector.yaml).

Five non-hostile flavor NPCs filling four previously-empty civilian rooms:
  Mos Eisley Inn              x2  (Innkeeper Sulina Vesh + Off-World Trader Varak Ness)
  Regional Government Offices x1  (Government Clerk Pell Darro)
  Spaceport Hotel             x1  (Hotel Clerk Besh Tillu)
  Dockside Cafe               x1  (CG-X2R droid bartender)
...
YAML_PATH = os.path.join(CW_DIR, "npcs_drop_ambient_mos_eisley_service_sector.yaml")
...
EXPECTED_NPCS = {
    "Innkeeper Sulina Vesh",
    "Off-World Trader Varak Ness",
    "Government Clerk Pell Darro",
    "Hotel Clerk Besh Tillu",
    "CG-X2R",
}
...
class TestEraRegistration(unittest.TestCase):
    def test_yaml_in_era_npcs_list(self):
        ...
        self.assertIn(
            "npcs_drop_ambient_mos_eisley_service_sector.yaml",
            names,
            "npcs_drop_ambient_mos_eisley_service_sector.yaml not in era.yaml content_refs.npcs",
        )

# -*- coding: utf-8 -*-
"""
tests/test_drop_mob_grind_tatooine.py

Verifies the Tatooine Jundland Wastes hostile-mob grind batch
...
MOB_FILE = os.path.join(CW_DIR, "npcs_drop_mob_grind_tatooine.yaml")
...
class TestEraManifestRef(unittest.TestCase):
    def test_file_in_era_yaml(self):
        ...
        ref_name = "npcs_drop_mob_grind_tatooine.yaml"
        self.assertIn(
            ref_name, npcs_refs,

# -*- coding: utf-8 -*-
"""
tests/test_drop_mob_grind_nar_shaddaa_deep.py

Verifies the Nar Shaddaa Warrens & Undercity hostile-mob grind expansion
(data/worlds/clone_wars/npcs_drop_mob_grind_nar_shaddaa_deep.yaml).
...
MOB_FILE = os.path.join(CW_DIR, "npcs_drop_mob_grind_nar_shaddaa_deep.yaml")
...
class TestEraManifestRef(unittest.TestCase):
    def test_file_in_era_yaml(self):
        ...
        ref_name = "npcs_drop_mob_grind_nar_shaddaa_deep.yaml"
        self.assertIn(
            ref_name, npcs_refs,

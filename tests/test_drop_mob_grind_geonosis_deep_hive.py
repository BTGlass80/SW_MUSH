# -*- coding: utf-8 -*-
"""
tests/test_drop_mob_grind_geonosis_deep_hive.py

Verifies the Geonosis Deep Hive hostile-mob grind batch
(data/worlds/clone_wars/npcs_drop_mob_grind_geonosis_deep_hive.yaml).
...
MOB_FILE = os.path.join(CW_DIR, "npcs_drop_mob_grind_geonosis_deep_hive.yaml")
...
class TestEraManifestRef(unittest.TestCase):
    def test_file_in_era_yaml(self):
        ...
        ref_name = "npcs_drop_mob_grind_geonosis_deep_hive.yaml"
        self.assertIn(
            ref_name, npcs_refs,
